...
SELECT REGION,YEAR,MIN(SALES_AMOUNT) AS 'MINIMUM' 
FROM SALES_DATA 
...
SELECT YEAR,PRODUCT,SUM(SALES_AMOUNT) AS 'TOTAL_AMOUNT' 
FROM SALES_DATA 
...
SELECT REGION,COUNT(DISTINCT PRODUCT) AS 'TOTAL_PRODUCTS' 
FROM SALES_DATA 
GROUP BY REGION 
...
SELECT YEAR,REGION,COUNT(PRODUCT) AS 'TOTAL_PRODUCTS' 
FROM SALES_DATA 
...
SELECT YEAR,COUNT(PRODUCT) AS 'ORDERS' 
FROM SALES_DATA 
GROUP BY YEAR,REGION 
