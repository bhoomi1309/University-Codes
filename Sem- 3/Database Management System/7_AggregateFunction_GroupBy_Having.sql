...
SELECT CITY,MAX(Salary) as 'Maximum' from EMP GROUP BY City HAVING City='Rajkot';

--5 Give maximum salary from IT department
SELECT Department,MAX(Salary) as 'Maximum' from EMP GROUP BY Department HAVING Department='IT';

--6 Count employee whose joining date is after 8-feb-91
SELECT COUNT(EID) as 'Total_Employees' from EMP WHERE JoiningDate>'8-feb-91';

--7 Display average salary of Admin department
SELECT Department,AVG(Salary) as 'Average' from EMP GROUP BY Department HAVING Department='Admin';

--8 Display total salary of HR department
SELECT Department,SUM(Salary) as 'Total_Salary' from EMP GROUP BY Department HAVING Department='HR';
...
SELECT CITY,MIN(Salary) as 'Minimum' from EMP GROUP BY City HAVING City='Ahmedabad';
